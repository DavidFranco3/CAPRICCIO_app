...
import { listarVentasSemana } from "../../api/ventas";
import GraficaVentasSemana from "../../components/HistoricoVentasSemana/GraficaVentasSemana";
import GraficaProductosSemana from '../../components/HistoricoVentasSemana/GraficaProductosSemana';
...
function GraficaSemanal(props) {
    const { semana, año, setRefreshCheckLogin, location } = props;
    ...
    const cargarDatos = () => {
        try {
            listarVentasSemana(semana, año).then(response => {
                const { data } = response;
